...
Quanto a avaliação do modo tutorial (questão 11) 69,4\% (43 voluntários) classificaram ele com o valor 4 ou 5 (Concordo fortemente). A distribuição destas respostas pode ser observada no gráfico da Figura~\ref{fig:graficoRespostasModoTutorial}.

\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{capitulos/figuras/grafico-respostas-modo-tutorial.jpg} 
    \caption{Gráfico com distribuição das respostas sobre avaliação do modo tutorial.}
    \label{fig:graficoRespostasModoTutorial}
\end{figure}
