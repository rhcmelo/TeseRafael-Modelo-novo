...
Nesta Seção é apresentada uma compilação das respostas dos participantes às perguntas do questionário. Na Tabela~\ref{tab:comparacaoRespostasFarber} está o comparativo das respostas dos especialistas obtidas pelo estudo feito por \textcite{Farber2008} e o nosso estudo. O restante das respostas ao questionário que foi apresentado para os voluntários, onde utilizou-se a mesma escala, está detalhado na Tabela~\ref{tab:demaisRespotasQuestionarioEspecialistas}.

\begin{table}[!ht]
\begin{center}
\caption{Comparativo das respostas às questões similares coletadas para o nosso ambiente de simulação e o simulador de \textcite{Farber2008}, média (desvio padrão).}
