...
\begin{table}[!ht]
\begin{center}
\caption{DEE estimados para os grupos populacionais de \cite{Sharma2011}.}
\label{tab:DEEEstimadosSharma}
\begin{tabular}{|c|c|c|c|c|}
\hline
\multirow{2}{*}{\textbf{IMC (kg/m\textasciicircum{}2)}} & \multicolumn{4}{l}{\textbf{DEE estimada (cm)}} \\
\hline\
                                               & \textbf{Brancas} & \textbf{Asiáticas/Britânicas Asiáticas} & \textbf{Negras/Britânicas negras} & \textbf{Chinesas} \\
\hline\hline
20 & 4,7 & 4,5  & 5,  & 4,4 \\
