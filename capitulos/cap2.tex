...
A anestesia raquidiana, também chamada de bloqueio subaracnóideo ou  raquianestesia, é o nome dado para a anestesia decorrente da aplicação de um anestésico local no interior do espaço subaracnóideo.

A posição ideal para a realização do bloqueio deve oferecer a coluna lombar de modo que as vertebras fiquem fletidas para frente. A ajuda do paciente é fundamental para acelerar o procedimento e reduzir a dor.

Existem duas principais formas para executar a raqui. A primeira o paciente fica deitado de lado com as pernas dobradas, joelhos no abdome e cabeça flexionada até que o queixo encoste no peito. Na segunda, ao invés de deitado, o paciente fica sentado com as mãos nos joelhos, ombros relaxados e queixo no peito. É muito importante que seja feito um movimento na coluna de flexão criando uma convexidade para trás.
...
Na seção \ref{sec:SimulacaoPacientesVirtuais} é proposto o uso de dados de trabalhos comentados aqui para modelagem de tecidos de pacientes grávidas.
