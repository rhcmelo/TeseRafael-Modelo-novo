...
Um fluxograma descrevendo as interações entre o usuário e o sistema contemplando todas as funcionalidades pode ser visto na 
Figura~\ref{fig:fluxogramaAmbiente}.

\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{capitulos/figuras/fluxograma-ambiente-desenvolvido.jpg} 
