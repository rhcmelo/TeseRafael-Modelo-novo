...
%Os trabalhos apresentados neste capítulo vão desde simuladores que usam só \textit{phantoms} a simuladores computacionais. É interessante destacar que alguns simuladores computacionais são híbridos no sentido de que usam \textit{phantoms} como parte do processo de simulação. 
