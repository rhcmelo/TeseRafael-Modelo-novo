...
% --- -----------------------------------------------------------------
\include{pre-textuais/cap0} %na pasta capítulos
...
\pagestyle{ruledheader}
\include{capitulos/cap3}  %inclui novo capítulo

\pagestyle{ruledheader}
\include{capitulos/cap4}  %inclui novo capítulo

\pagestyle{ruledheader}
\include{capitulos/cap5}  %inclui novo capítulo

\pagestyle{ruledheader}
\include{capitulos/cap6}  %inclui novo capítulo

\pagestyle{ruledheader}
\include{capitulos/cap7}  %inclui novo capítulo
