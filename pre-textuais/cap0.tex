...
Errors are reported during each procedure to enable the evolution of the learner's practice. As a result of the sensation representation test, the experiment showed that the volunteers were able to identify the different desirable behaviors for simulating spinal anesthesia. The usability of the system was evaluated as good. The experts' evaluation made it possible to compare with another simulator regarding part of the questionnaire responses. Experts saw potential in the simulation environment and found this training type helpful. 
